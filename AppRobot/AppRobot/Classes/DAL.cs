        ...
        public static User ConnectionUtilisateur(User utilisateur)
        {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    utilisateur.DateOfBirth = dr.GetDateTime(3);
                    utilisateur.TypeUtilisateurs = (User.TypeUser)Enum.Parse(typeof(User.TypeUser), dr.GetString(4));
        ...
        public static List<User> ObtainListUsers(User userDemandant, string username = null)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    dr.GetString(2),
                    dr.GetDateTime(3),
                    (User.TypeUser)Enum.Parse(typeof(User.TypeUser), dr.GetString(4)),
