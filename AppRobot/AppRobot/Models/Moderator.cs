...
namespace AppRobot.Models
{
    ...
    {
        public Moderator(int id, string username, string password, DateTime dateOfBirth, TypeUser user, string img, bool acces, Dictionary<string, Fonctionnalite> listeFonctionnalite) : base(id, username, password, dateOfBirth, user, img, acces, listeFonctionnalite)
        {
        }
