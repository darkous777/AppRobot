...
namespace AppRobot.Models
{
    ...
    {
        public Moderator(int id, string username, string password, DateOnly dateOfBirth, TypeUser user, String img, bool acces, Dictionary<string, Fonctionnalite> listeFonctionnalite) : base(id, username, password, dateOfBirth, user, img, acces, listeFonctionnalite)
        {
        }
